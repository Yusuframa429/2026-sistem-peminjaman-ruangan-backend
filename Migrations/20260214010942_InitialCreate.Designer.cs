...
namespace _2026_sistem_peminjaman_ruangan_backend.Migrations
{
    ...
    [Migration("20260214010942_InitialCreate")]
            ...
            modelBuilder.Entity("_2026_sistem_peminjaman_ruangan_backend.Models.Peminjaman", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Status = "Menunggu",
                            TanggalPeminjaman = new DateTime(2026, 2, 15, 8, 9, 38, 482, DateTimeKind.Local).AddTicks(8533)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            Ruangan = "Aula Besar",
                            Status = "Disetujui",
                            TanggalPeminjaman = new DateTime(2026, 2, 17, 8, 9, 38, 484, DateTimeKind.Local).AddTicks(6134)
                        });
                });
